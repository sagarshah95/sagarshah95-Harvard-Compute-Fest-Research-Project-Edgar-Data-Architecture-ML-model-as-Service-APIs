...
def store_data_to_dataframe():
    df_sentimentScore['text'] = sentence1
    df_sentimentScore['label'] = sentiment_score
    #df_sentimentScore['sentiment_magnitude'] = sentiment_magnitude
    #df_sentimentScore['language'] = langue
    df_sentimentScore.to_csv('/root/EdgarPipeline/Sentiment_Labled_Data_csv.csv')
